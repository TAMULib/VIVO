...
<footer role="contentinfo">
    <p class="copyright">
        <#if copyright??>
            ...
            <#else>
             ...
             | <a class="terms" href="//library.tamu.edu/services/scholarly_communication/scholars/terms.html" title="${i18n().menu_termuse}">${i18n().menu_termuse}</a></small> | 
        </#if>
 ...
 <li role="listitem"><a href="//library.tamu.edu/services/scholarly_communication/scholars/contact.html" title="${i18n().menu_contactus}">${i18n().menu_contactus}</a></li>
