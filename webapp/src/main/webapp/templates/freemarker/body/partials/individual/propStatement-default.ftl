	...
	<#else>
		...
		<#if statement.type! == "Thesis">
			...
			<#if ( statement.label?index_of(" Master's Thesis.") > 1 ) >
				...
				<br />
				<img src="${urls.base}/themes/tamu/images/masters.png" title="Doctoral Dissertation" alt="Doctoral Dissertation">		
			<#--	<a href="http://hdl.handle.net/1969.1/${profileUrl(statement.uri("object"))?replace("/vivo/display/n", "")}" title="${i18n().name}"><img src="${urls.base}/themes/tamu/images/openaccess.png" title="Open Access Link" alt="Open Access Link"></a>				-->
			<#elseif ( statement.label?index_of(" Doctoral Dissertation.") > 1 ) >
				...
				<br />
				<img src="${urls.base}/themes/tamu/images/doctoral.png" title="Doctoral Dissertation" alt="Doctoral Dissertation">				
			<#--	<a href="http://hdl.handle.net/1969.1/${profileUrl(statement.uri("object"))?replace("/vivo/display/n", "")}" title="${i18n().name}"><img src="${urls.base}/themes/tamu/images/openaccess.png" title="Open Access Link" alt="Open Access Link"></a>		-->
			</#if>	
