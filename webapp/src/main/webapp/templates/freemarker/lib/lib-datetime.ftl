...
<#macro citation_yearSpan dateTime>
    <#if dateTime?has_content>
        <@citation_dateTimeSpan>${xsdDateTimeToYear(dateTime)}</@citation_dateTimeSpan>
    </#if>
</#macro>
...
<#macro citation_dateTimeSpan>
    <span class="citation_listDateTime">(<#nested>).</span>
</#macro>
